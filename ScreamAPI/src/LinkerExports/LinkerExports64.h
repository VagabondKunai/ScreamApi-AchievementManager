...
#pragma comment(linker, "/export:EOS_Platform_SetApplicationStatus=EOSSDK-Win64-Shipping_o.EOS_Platform_SetApplicationStatus")
#pragma comment(linker, "/export:EOS_Platform_SetNetworkStatus=EOSSDK-Win64-Shipping_o.EOS_Platform_SetNetworkStatus")
